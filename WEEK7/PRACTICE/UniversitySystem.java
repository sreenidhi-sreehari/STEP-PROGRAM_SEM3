...
class Professor extends Person {
    ...
    public Professor(String name, int age, String email, String department) {
        super(name, age, email); this.department = department;
    }
...
public class UniversitySystem {
    public static void main(String[] args) {
        ...
        p.introduce();         // Allowed: defined in Person
        p.getContactInfo();    // Allowed
        // p.attendLecture();  // Compile error: method not in Person
        System.out.println("Access name: " + p.name); // Allowed
        // Upcasting is safe but you can't access subclass-only methods or fields!
    }
}
